...
| Plataforma | Arquivo |
| --- | --- |
| Windows | `4C-Launcher-Setup-<versão>.exe` |
| Linux | `.AppImage`, `.deb` ou `.zip` |

O launcher verifica novas versões automaticamente e avisa quando sair uma atualização.
...
- **Loja de cosméticos** — minere esmeraldas jogando e desbloqueie temas visuais e telas de abertura animadas: Gênese, Forja Ardente, Portal do Nether, Mesa Encantada e Veio de Esmeralda.

## Sobre a TotalCraft Network
